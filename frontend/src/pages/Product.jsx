...
const Product = () => {
  ...
  const { products, currency, addToCart, isInCart, goToCart } = useContext(ShopContext)
      ...
      <div className='flex gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          {isInCart(productData._id) ? (
            ...
            <button onClick={() => addToCart(productData._id)} className='bg-black text-white px-8 py-3 text-sm mt-6 '>
              ADD TO CART
            </button>
          )}
          ...
          <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
            ...
            <p>Easy return or replacement within 2 days if damaged or expired upon delivery.</p>
          </div>
        </div>
      </div>
